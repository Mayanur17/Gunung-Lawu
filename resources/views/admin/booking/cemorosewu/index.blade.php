    ...
    <table class="glw-table-booking">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('booking.cemorosewu.detail', $b->id) }}" class="btn-detail">Detail</a>

                    @if($b->status != 'approve' && $b->status != 'decline')
                        <form action="{{ route('booking.cemorosewu.approve', $b->id) }}" method="POST" style="display:inline;">
                            @csrf
                            <button type="submit" class="btn-approve">Setujui</button>
                        </form>

                        <form action="{{ route('booking.cemorosewu.decline', $b->id) }}" method="POST" style="display:inline;" onsubmit="return confirmTolak(this);">
                            @csrf
