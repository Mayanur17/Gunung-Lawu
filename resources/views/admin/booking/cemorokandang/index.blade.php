    ...
    <table class="glw-table-booking">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('booking.cemorokandang.detail', $b->id) }}" class="btn-detail">Detail</a>

                    @if($b->status != 'approve' && $b->status != 'decline')
                        <form action="{{ route('booking.cemorokandang.approve', $b->id) }}" method="POST" style="display:inline;">
                            @csrf
                            <button type="submit" class="btn-approve">Setujui</button>
                        </form>

                        <form action="{{ route('booking.cemorokandang.decline', $b->id) }}" method="POST" style="display:inline;" onsubmit="return confirmTolak(this);">
                            @csrf
