...
class CreateCemorokandangDetailTable extends Migration
{
    public function up()
    {
        Schema::create('cemorokandang_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('cemorokandang_detail');
    }
}
